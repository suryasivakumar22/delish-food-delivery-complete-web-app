...
<body>
	...
	<input type="hidden" class="hnu" value="<?php echo $_SESSION['het'].'a' ?>">
				  ...
				  <div class="card-horizontal">
					 <div class="card-body" id="car">
						...
						<?php if ($faip[$i22]['stock'] === 'instock') { ?>
							<?php if ($oimp) { ?>
								<?php if ($oimp[0]['id']==($faip[$i22]['id'].$valv['categories'].'a')) { ?>
								<button type="button" class="cla" style="outline: none;display: none;"  id="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>" value="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>">
								...
								<div  class="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>" style='display: block;'>
								...
								<button type="button" class="cla" style="outline: none;"  id="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>" value="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>">
									<div class="clee" id="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>">
									</div> 
									Add
								</button>
						...
						<?php }}else{ ?>
							...
							<button type="submit" class="cla" style="outline: none;display: block;"  id="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>" value="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>">
									<div class="clee" id="<?php echo  $faip[$i22]['id'].$valv['categories'].'a'; ?>">
									</div> 
									Add
								</button>
